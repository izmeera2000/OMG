			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-4 d-flex align-items-stretch">
						<div class="content">
							<h3>Why Choose <br>OMG Computer?</h3>
							<p>
							Our team comprises highly trained professionals with extensive experience in computer engineering. We have the knowledge and skills to address a wide range of computer-related issues effectively
							</p>
							...
							<div class="row">
								<div class="col-xl-4 d-flex align-items-stretch">
									<div class="icon-box mt-4 mt-xl-0">
										...
										<p>We understand that every computer setup is unique. We offer customized solutions tailored to meet your specific needs, ensuring optimal performance and reliability.</p>
									</div>
								</div>
								<div class="col-xl-4 d-flex align-items-stretch">
									<div class="icon-box mt-4 mt-xl-0">
										...
										<p>Your satisfaction is our top priority. We are committed to providing outstanding customer service and support throughout the entire service journey, ensuring a positive experience from start to finish</p>
									</div>
								</div>
								<div class="col-xl-4 d-flex align-items-stretch">
									<div class="icon-box mt-4 mt-xl-0">
										...
										<p>Technology evolves rapidly, and so do we. We stay updated with the latest advancements in computer engineering to offer innovative solutions that keep your systems at the forefront of performance and security</p>
									</div>
								</div>
							</div>
						</div><!-- End .content-->
			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					<div
						...
						<h3>Why We're Your Best Choice</h3>
						...
						<div class="icon-box">
							...
							<h4 class="title">Customized Builds for Every Need</h4>
							<p class="description"> Whether you're a gamer, a content creator, or a professional, we offer custom PC builds tailored to your specific requirements and budget</p>
						</div>

						<div class="icon-box">
							<div class="icon"><i class="bx bx-gift"></i></div>
							<h4 class="title">Thorough Testing</h4>
							<p class="description">Every build undergoes rigorous testing to ensure stability, performance, and reliability so that you get a flawless PC right out of the box</p>
						</div>

						<div class="icon-box">
							<div class="icon"><i class="bx bx-atom"></i></div>
							<h4 class="title">Future-Proofing Your Investment</h4>
							<p class="description">We choose components that offer upgrade potential, ensuring your system remains relevant and powerful for years to come with minimal future upgrades</p>
						</div>
				...
				<div class="row">
					<div class="col-lg-4 col-md-6 d-flex align-items-stretch">
						<div class="icon-box">
							...
							<h4><a href="">Custom PC Building</a></h4>
					...
					<div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
						<div class="icon-box">
							...
							<h4><a href="">PC Upgrades & Optimization</a></h4>
					...
					<div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
						<div class="icon-box">
							...
							<h4><a href="">PC Repairs & Troubleshooting</a></h4>
					...
					<div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
						<div class="icon-box">
							...
							<h4><a href="">Remote Support & Assistance</a></h4>
					...
					<div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
						<div class="icon-box">
							...
							<h4><a href="">Software Installation & Setup</a></h4>
					...
					<div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
						<div class="icon-box">
							...
							<h4><a href="">Virus Removal & Protection</a></h4>
